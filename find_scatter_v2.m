function [occurance, index]=find_scatter_v2(pkh,pkl,lnh,lnl)
    pg=1;
     index=zeros(100,1);
  ...
  if lnh(1)>lnl(1)
      ...
      d_var=var(dif);
       ...
       con=( (diffh>d_mode+pg*d_var ) | (diffh<d_mode-pg*d_var  ));
      conl=( (diffl>d_mode+pg*d_var ) | (diffl<d_mode-pg*d_var  ));
