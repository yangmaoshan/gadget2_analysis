...
function [Mean, ave_Dispe, delta_R_over_R, kk, change_plus, change_minus, n_plus, n_minus, c_plus, c_minus, med1, med2]=fplot_R_change_v10_25(ni,nf,ri,rf,len,Rnumber)
...
title(ax1,'Mean');
title(ax2,'Median');
title(ax3,'Percentage above  dispersoin');
title(ax4,'Percentage below  -dispersoin');
title(ax5,'Variance');
title(ax6,'Dispersion');

fname1=['Run_'  num2str(Rnumber)  '_Change' num2str(ni) '_to_' num2str(nf) '_v10_18.mat'];
fname2=['Plot_Run_'  num2str(Rnumber)  '_Change' num2str(ni) '_to_' num2str(nf) '_v10_18.png'];
saveas(gcf,fname2);
