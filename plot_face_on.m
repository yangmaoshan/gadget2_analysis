...
gra1=scatter(ax{countt},C2(1,:),C2(2,:),10,'.');
gra1.MarkerEdgeAlpha = 0.1;
axis(ax{countt},'equal');axis(ax{countt},[-gsize_s+p0(1) gsize_s+p0(1) -gsize_s+p0(2) gsize_s+p0(2)]);
%{
